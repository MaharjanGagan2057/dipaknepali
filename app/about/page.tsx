...
const About = () => {
  return (
   <div className=" text-center text-2xl p-30 h-screen  bg-gray-100 text-black dark:bg-gray-800  dark:text-white ">
  <section className="bg-gray-100 rounded-2xl">
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 m-10">
